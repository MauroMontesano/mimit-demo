...
@Component({
  selector: 'eaf-input-select-old',
  templateUrl: './input-select-old.component.html',
  styleUrls: ['./input-select-old.component.scss'],
  encapsulation: ViewEncapsulation.None,
  providers: [
    {
      provide: NG_VALUE_ACCESSOR,
      useExisting: forwardRef(() => InputSelectOldComponent),
      multi: true,
    },
    {
...
export class InputSelectOldComponent extends BaseInputComponent implements AfterViewInit, OnDestroy {
  ...
  public onChangeSelect = ($event: any) => {
    ...
    const selections = this.initialized.selectpicker('val');
