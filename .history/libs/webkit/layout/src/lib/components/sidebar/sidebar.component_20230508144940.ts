...
export class SidebarComponent implements OnInit {
  ...
  @Input() toggleStato = true;
  @Output() toggleStatoChange = new EventEmitter<boolean>();
  opened = false;
  fullHide = false;
  bsCollapse?: Collapse;
  ...
  toggleCollapse(id: string) {
    ...
    if (collapseElement) {
      ...
      this.toggleStatoChange.emit(this.toggleStato);
    }
  }
...
function Output(): (target: SidebarComponent, propertyKey: "toggleStatoChange") => void {
