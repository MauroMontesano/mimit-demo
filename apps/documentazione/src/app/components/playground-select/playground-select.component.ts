...
@Component({
  selector: 'eaf-playground-select',
  templateUrl: './playground-select.component.html',
  encapsulation: ViewEncapsulation.None,
})
export class PlaygroundSelectComponent extends FormBasePageComponent<any> {
  optionsList: any[] = [];
  optionsLong: any[] = [];
  groupOptionsList: any = { gruppo1: [], gruppo2: [] };
  myWrappedForm: EafForm;
  tooltip = new TooltipModel('Test content', undefined, 'prova');
  ...
  createForm(form: any): UntypedFormGroup {
    ...
    form.addControl('tooltip', new UntypedFormControl(undefined));
    form.addControl('actions', new UntypedFormControl(undefined));
